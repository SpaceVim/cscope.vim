...
function! cscope#_CheckNewFile(dir, newfile)
...
function! cscope#_ListFiles(dir)
  let d = []
  let f = []
  let cwd = a:dir
  let sl = &l:stl
...
" 0 -- loaded
" 1 -- cancelled
function! cscope#_AutoloadDB(dir)
  let ret = 0
...
function! cscope#_listDirs(A,L,P)
  return keys(s:dbs)
endfunction
